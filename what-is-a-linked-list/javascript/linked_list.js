...
let firstDrink = new Node("Coffee")
let secondDrink = new Node("Manhattan")
let thirdDrink = new Node("Brandy")

firstDrink.next = secondDrink
secondDrink.next = thirdDrink

drinks = new LinkedList(firstDrink)
